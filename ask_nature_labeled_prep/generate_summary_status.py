...
status_summary_df = pd.DataFrame(
    columns=['literature_site', 'num_papers', 'success', 'error', 'no_code', 'no_labels', 'avg_scrape_time'])
for literature_site, group in literature_site_groups:
    ...
    status_summary_df = status_summary_df.append(
        {'literature_site': literature_site, 'num_papers': num_papers, 'success': success, 'error': error,
         'no_code': no_code, 'no_labels': no_labels,'avg_scrape_time': avg_scrape_time}, ignore_index=True)
